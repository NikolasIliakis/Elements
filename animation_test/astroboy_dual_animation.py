...
def main(imguiFlag = False):
    ...
    vertices_2, colors_2, boneWeight_2, boneID_2, faces_2, BB_2 = animationInitialize('C:/Users/user-P/Desktop/Elements_Home/thes/astroBoy_walk.dae', key1_2, key2_2, key3_2)

    #Generating normals
    normals_2 = norm.generateNormals(vertices , faces)
    ...
    while running:
        ...
        MM_2 = animationLoop(key1_2, key2_2, key3_2)
        ...
        shaderDec4_2.setUniformVariable(key='BB', value=BB_2, arraymat4=True)
