...
class SkinnedAnimationSystem(System):
    ...
    def apply2AnimationComponents(self, animationComponents: Elements.pyECSS.Component.AnimationComponents):

        if (isinstance(animationComponents, Elements.pyECSS.Component.AnimationComponents)) == False:
